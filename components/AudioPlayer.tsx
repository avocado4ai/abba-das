...
export default function AudioPlayer({ text }: { text: string }) {
  ...
  return (
    <div className="flex items-center gap-3 bg-sage/5 border border-sage/10 rounded-2xl sm:rounded-full px-3 sm:px-4 py-2 mt-4 sm:mt-6">
      <button
        onClick={togglePlay}
        className="w-10 h-10 shrink-0 rounded-full bg-sage text-cream flex items-center justify-center hover:bg-navy transition-all shadow-sm"
