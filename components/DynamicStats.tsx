...
export default function DynamicStats({ posts }: { posts: PostData[] }) {
  ...
  return (
    <div className="w-full max-w-md bg-linear-to-br from-white/5 to-white/10 border border-border-theme rounded-2xl p-8 relative overflow-hidden group hover:border-coral/30 transition-all duration-250 shadow-sm hover:shadow-md">
      ...
      <div className="flex items-center justify-center gap-8 relative z-10">
        <div className="text-center">
          <div className="text-4xl font-bold bg-linear-to-r from-coral to-warm-gold bg-clip-text text-transparent mb-1">{stats.count}</div>
        ...
        <div className="text-center">
          <div className="text-4xl font-bold bg-linear-to-r from-teal to-sage bg-clip-text text-transparent mb-1">{stats.readingTime}</div>
